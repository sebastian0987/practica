            ...
            <form class="form-horizontal" method="post" action="#">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                            <input type="password" class="form-control" name="password" id="nuevaPassword"  placeholder="Ingrese su contraseña"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password" class="cols-sm-2 control-label">Confirmar nueva contraseña</label>
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                            <input type="password" class="form-control" name="password" id="nuevaConfirmarPassword"  placeholder="Ingrese su contraseña"/>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="js/modificar-usuario.js"></script>
...
<!--                        aria-hidden="true">&times;</span></button>-->
            ...
            <div class="modal-body">
                <p>Su nueva contraseña ha sido ingresada con éxito.</p>
            </div>
