    ...
    <div class="row main">
        ...
        <div class="main-login main-center">
            <form class="form-horizontal" method="post" action="#">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="correo" id="correo"  placeholder="Ingrese su correo electrónico" disabled/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="name" class="cols-sm-2 control-label" style="text-align: left">Ingrese el correo electrónico del usuario que desea eliminar</label>
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="correo" id="correoEliminar"  placeholder="Ingrese su correo electrónico"/>
                        </div>
                    </div>
                </div>
                <div class="form-group ">
...
<script type="text/javascript" src="js/eliminar-usuario.js"></script>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalError">
    <div class="modal-dialog">
        <div class="modal-content">
            <div id="encabezadoModalMensaje" class="modal-header" style="background-color: #FFBABA">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 id="h4Error" class="modal-title">Error</h4>
            </div>
            <div class="modal-body">
                <p id="pError">Han surgido problemas al intentar conectarse al servidor, vuelva a intentarlo mas tarde.</p>
            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalMensaje">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Se ha eliminado al usuario correctamente.</p>
            </div>
            <div class="modal-footer">
